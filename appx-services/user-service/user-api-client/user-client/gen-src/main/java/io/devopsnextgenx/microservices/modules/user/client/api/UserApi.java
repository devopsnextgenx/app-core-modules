package io.devopsnextgenx.microservices.modules.user.client.api;

import io.devopsnextgenx.microservices.modules.user.client.ApiClient;
import io.devopsnextgenx.microservices.modules.user.client.BaseApi;

import java.util.UUID;
import io.devopsnextgenx.microservices.modules.user.client.dto.User;
...
public class UserApi extends BaseApi {
     ...
     */
    public void deleteUserById(UUID id) throws RestClientException {
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<Void> deleteUserByIdWithHttpInfo(UUID id) throws RestClientException {
        Object localVarPostBody = null;
        
        // verify the required parameter 'id' is set
        if (id == null) {
            throw new HttpClientErrorException(HttpStatus.BAD_REQUEST, "Missing the required parameter 'id' when calling deleteUserById");
        }
        ...
        return apiClient.invokeAPI("/user/{id}", HttpMethod.DELETE, uriVariables, localVarQueryParams, localVarPostBody, localVarHeaderParams, localVarCookieParams, localVarFormParams, localVarAccept, localVarContentType, localVarAuthNames, localReturnType);
    }
    /**
     * Get User By Id
     * 
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public User getUserById(UUID id) throws RestClientException {
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<User> getUserByIdWithHttpInfo(UUID id) throws RestClientException {
        Object localVarPostBody = null;
    ...
    public User saveUser(User user) throws RestClientException {
        return saveUserWithHttpInfo(user).getBody();
    }
     ...
     * @throws RestClientException if an error occurs while attempting to invoke the API
     */
    public ResponseEntity<User> saveUserWithHttpInfo(User user) throws RestClientException {
